...
function StartupViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<StartupInterface>(
    ...
    () =>
      getStartupById(id, {
        relations: ['user', 'content', 'subscription'],
      }),
  );
              ...
              {hasAccess('content', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/contents/create?startup_id=${data?.id}`}>
              ...
              {hasAccess('subscription', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/subscriptions/create?startup_id=${data?.id}`}>
                      <Button colorScheme="blue" mr="4" as="a">
                        Create
                      </Button>
                    </NextLink>
